...
main( ) 
{
	...
	//vColor    = aColor;				// don't use the color from the vertex data
	vColor = Object.uColor.rgb;			// instead use the color from the uniform variables
	vTexCoord = aTexCoord;
	...
	// if not doing instancing, end with this:
